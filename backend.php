...
if ($userMessage === "start") {
    $introduction = "Bonjour ! Le savoir-faire français vous passionne ? Ça tombe bien, je suis un expert ! 
    Saviez-vous que la France est renommée pour son excellence dans l’artisanat, la gastronomie et l’innovation, 
    du travail du cuir à la haute cuisine en passant par l’aéronautique ? 
    Voulez-vous en découvrir davantage sur un domaine en particulier ou entendre une anecdote fascinante ?";
